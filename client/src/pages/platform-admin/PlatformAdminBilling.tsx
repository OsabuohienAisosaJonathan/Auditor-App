...
export default function PlatformAdminBilling() {
  ...
  const updateSubscriptionMutation = useMutation({
    mutationFn: async ({ orgId, data }: { orgId: string; data: any }) => {
      const response = await fetch(`/api/platform-admin/organizations/${orgId}/subscription`, {
        method: "PATCH",
  ...
  const grantFreeAccessMutation = useMutation({
    mutationFn: async ({ orgId, data }: { orgId: string; data: any }) => {
      const response = await fetch(`/api/platform-admin/organizations/${orgId}/grant-free-access`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify(data),
  ...
  const extendSubscriptionMutation = useMutation({
    mutationFn: async ({ orgId, data }: { orgId: string; data: any }) => {
      const response = await fetch(`/api/platform-admin/organizations/${orgId}/extend-subscription`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify(data),
