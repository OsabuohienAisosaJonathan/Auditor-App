...
export default function Contact() {
  ...
  const inputClasses = "h-11 transition-all duration-200 focus:ring-2 focus:ring-primary/20";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-3">
              <Button variant="ghost" onClick={() => setLocation("/login")} data-testid="nav-signin">Sign In</Button>
              <Button onClick={() => setLocation("/signup")} className="transition-all duration-200 hover:scale-[1.02] hover:shadow-md" data-testid="nav-get-started">
                Get Started
              </Button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1 space-y-6">
              ...
              <Card className="bg-primary/5 border-primary/20 transition-all duration-300 hover:shadow-lg">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <SelectTrigger className={inputClasses} data-testid="select-contact-subject">
                    ...
                    <Button 
                      type="submit" 
                      className="w-full sm:w-auto px-8 transition-all duration-200 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98]"
      ...
      <footer className="border-t border-border py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-3">
              <img src={logoImage} alt="MiAuditOps" className="h-8 object-contain" />
              <span className="font-display font-bold">MiAuditOps</span>
            </div>
