...
import { AlertTriangle, FileText, Plus, Upload, ShoppingCart, BarChart3, AlertOctagon, FileCheck, Building2, Calendar, Download, FileSpreadsheet, CalendarDays, RefreshCw } from "lucide-react";
  ...
  if (error && !summary) {
    ...
    return (
      <Empty className="min-h-[400px] border" data-testid="error-dashboard">
        ...
        <EmptyHeader>
          <EmptyTitle>
            {isAuthError ? "Session expired" : isTimeout ? "Request timed out" : "Failed to load dashboard"}
          </EmptyTitle>
          <EmptyDescription>
            {isAuthError 
