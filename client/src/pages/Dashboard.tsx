        ...
        <>
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            <div className="lg:col-span-2 space-y-8">
              ...
              {(summary?.recentExceptions && Array.isArray(summary.recentExceptions) && summary.recentExceptions.length > 0) && (
                <Card className="audit-card">
                  <CardHeader>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {(summary?.recentExceptions && Array.isArray(summary.recentExceptions) ? summary.recentExceptions : []).slice(0, 5).map((exception) => (
              ...
              {(summary?.openExceptions && summary.openExceptions > 0) ? (
                <Card className="border-l-4 border-l-destructive shadow-sm">
                  ...
                  <CardContent className="space-y-4">
                    {(summary?.redFlags && Array.isArray(summary.redFlags) ? summary.redFlags : []).map((flag, index) => (
